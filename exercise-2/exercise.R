# chapter8 Exercise 2: using `*apply()` functions
Joy Liu 4/6/2018
...
sentence <- c("JOY is constantly LEARNING and MAKING PROGRESS.")
lapply(sentence, tolower)
...
frequencies <- as.list(sapply(unique_letters, count_occurences,letters))
